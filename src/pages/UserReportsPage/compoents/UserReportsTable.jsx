...
import { setUserReport } from '../../../redux/slice/ReportSlice';
...
export default function UserReportsTable() {
    ...
    const fetchData = async () => {
      try {
        ...
        snapshot.forEach((doc) => {
          ...
          if (items.userReports && Array.isArray(items.userReports)) {
            reportsList = [...reportsList, ...items.userReports];
          }
        });
  ...
  const handleNavigate = (object) => {
    dispatch(setUserReport(object));
    navigate('/user-report/details');
  };
    ...
    <div className="page__table">
      ...
      <table className="table table-hover">
        <thead>
          <tr>
            <th scope="col">#</th>
            <th scope="col">Reported Vendor</th>

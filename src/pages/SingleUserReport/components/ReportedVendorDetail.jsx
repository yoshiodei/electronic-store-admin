...
export default function ReportedVendorDetail({ reportedVendorData }) {
  const navigate = useNavigate();
  const {
    reportDetail, reportType, reportedVendorId, reportedVendorName,
  } = reportedVendorData;
    ...
    <div className="report-page__reported-vendor-panel">
      ...
      <div className="mt-4">
        <div className="user-profile__info-item">
          ...
          <h5 className="user-profile__info-value">{ reportedVendorName }</h5>
        </div>
        <div className="user-profile__info-item">
      ...
      <div className="mt-5 report-page__reported-vendor-panel__buttons-div">
        <button
          ...
          type="button"
          onClick={() => {
            navigate(`/product/${reportedVendorId}`);
          }}
        >
          View Reported Item
